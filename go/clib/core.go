...
//
// libtabnasjsonl is the jsonl format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/jsonl/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnasjsonl"
	formatName      = "jsonl"
	valueOut        = true
)
...
// newParser builds one engine with the jsonl grammar installed
...
func newParser() (parseFn, error) {
	tn := plug.Make(); return tn.Parse, nil
}
...
// parseWith answers whether src is in the jsonl language — and,
